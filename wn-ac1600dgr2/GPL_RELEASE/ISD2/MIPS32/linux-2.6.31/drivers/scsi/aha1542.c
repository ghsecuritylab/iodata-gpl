/* $Id: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/scsi/aha1542.c#1 $
...
/*
   static const char RCSid[] = "$Header: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/scsi/aha1542.c#1 $";
 */
