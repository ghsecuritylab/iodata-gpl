...
#define CONFIG_FEATURE_CMP_LIMIT 1
...
static const char opt_chars[] ALIGN1 = "sln";
...
#ifdef CONFIG_FEATURE_CMP_LIMIT
    opt = getopt32(argv, "sl:n:", &lscontext, &ncontext);
#else
    opt = getopt32(argv, "sl");
#endif
