...
struct dhcp_option dhcp_options[] = {
	...
	{"broadcast",	OPTION_IP | OPTION_REQ,			0x1c},
        /*cfho 2008-0711, remove some uncessary options */
	...
	{"nodetype",    OPTION_U8,                 				0x2e},
	{"scope",       OPTION_STRING,                			0x2f},
...
#define MAX_LENGTH	308
#if FOR_REALTEK_PLATFORM || FOR_UBICOM_PLATFORM
/** cfho 2010-0625, it is safe for big endian system. we met issue on RTL8196x platform */
uint8_t mybuf[MAX_LENGTH+20];
#endif
