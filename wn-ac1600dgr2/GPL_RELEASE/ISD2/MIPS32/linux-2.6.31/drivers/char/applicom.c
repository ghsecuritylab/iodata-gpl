...
/* $Id: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/char/applicom.c#1 $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/char/applicom.c#1 $\n");
