...
#if HAS_SUPPORT_REGULAR_FILE /* cfho 2008-0724 */
...
static void recursive_add_directory(char *dname)
{
	...
	while ((dp = readdir(dir))) {
...
#if HAS_SUPPORT_DIRECTORY /* cfho 2008-0724 */
		case S_IFDIR:
		...
		case S_IFREG:
			...
			/* fallthrough */
		case S_IFSOCK:
#if HAS_SUPPORT_FIFO /* cfho 2008-0724 */
		case S_IFIFO:
#endif
pipenode:
		case S_IFLNK:
...
#if HAS_REDUCE_CODE_SIZE /* cfho 2007-1106 */
#else
...
int main(int argc, char **argv)
{
	...
	FILE *devtable = NULL;
#if HAS_REDUCE_CODE_SIZE /* cfho 2007-1106 */
while ((opt = getopt_long(argc, argv, "d:o:", 
            long_options, &c)) >= 0) {
        switch (opt) {
        case 'r':
