...
#if defined(CONFIG_IP_TURBO_NAT) || defined(CONFIG_NF_TURBO_NAT) || defined(CONFIG_IP_TURBO_NAT_MODULE)
extern int (*tbo_nat_pppox_hook_create)(int sa_protocol,
					struct pppox_sock *sock);
extern int (*tbo_nat_pppox_hook_delete)(int sa_protocol,
					struct pppox_sock *sock);
#endif
...
#if defined(CONFIG_IP_TURBO_NAT) || defined(CONFIG_NF_TURBO_NAT) || defined(CONFIG_IP_TURBO_NAT_MODULE)
	if (tbo_nat_pppox_hook_create)
		tbo_nat_pppox_hook_create(PX_PROTO_PPTP, sock);
#endif	
	res=0;
...
#if defined(CONFIG_IP_TURBO_NAT) || defined(CONFIG_NF_TURBO_NAT) || defined(CONFIG_IP_TURBO_NAT_MODULE)
	if (tbo_nat_pppox_hook_delete)
		tbo_nat_pppox_hook_delete(PX_PROTO_PPTP, sock);
#endif	
