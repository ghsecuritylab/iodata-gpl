/*
  ...
  $Header: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/qca_main/components/os/linux-2.6.31/1.0/drivers/scsi/osst.c#1 $";
