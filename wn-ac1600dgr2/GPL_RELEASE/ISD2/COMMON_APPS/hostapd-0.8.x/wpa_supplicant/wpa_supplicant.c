...
#if 1 /* Senao patch */
		/* yolin: we must check lan connect type before do dhcpc renew */
		system("sysconf_cli inform sitesurvey-success-dhcpc-renew &");
#endif
...
#if 0
			int timeout = 60;
        /*jaykung 20090821, reduce timeout to speed up roaming*/
#else
            int timeout = 10;
#endif
