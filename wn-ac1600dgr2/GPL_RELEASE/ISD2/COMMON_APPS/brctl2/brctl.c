...
int xioctl(int fd, unsigned request, void *argp)
{
        int ret;
                ...
                if (key == ARG_show) { /* show */
                        ...
                        for (i = 0; i < num; i++) {
                                ...
                                if (!if_indextoname(bridx[i], brname))
                                {
                                    ...
                                    printf("Error: can't get bridge name for index %d", i);
                                    exit(1);
                                }
                                ...
                                for (j = 0; j < MAX_PORTS; j++) {
                                        ...
                                        if (!if_indextoname(ifidx[j], ifname))
                                        {
                                            ...
                                            printf("can't get interface name for index %d", j);
                                            exit(1);
                                        }
                                        if (tabs)
                                                printf("\t\t\t\t\t");
