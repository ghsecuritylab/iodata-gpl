...
#define SILEX_PATCH_2010_05_26 // 2010.05.26 silex patch
...
#ifdef SILEX_PATCH_2010_05_26
static int sysfs_get_busnum(const char *devname)
{
	int r;
...
#ifdef SILEX_PATCH_2010_05_26
	busnum = sysfs_get_busnum(devname);
#else /* original */
