...
extern unsigned char nf_athrs17_hnat_wan_ip[ATHRS17_PEER_IP_LEN];
#endif

MODULE_LICENSE("GPL");

#ifdef CONFIG_IP_CONNTRACK_NAT_SESSION_RESERVATION
extern int nf_conntrack_max_0;
#endif
...
//		.ctl_name	= NET_NF_ATHRS17_HNAT_WAN_MAC,
	...
	{
		.procname	= "nf_athrs17_hnat_wan_ip",
		.data		= &nf_athrs17_hnat_wan_ip,
		.maxlen		= ATHRS17_PEER_IP_LEN,
		.mode		= 0644,
		.proc_handler	= proc_dostring
	},
#endif
#ifdef CONFIG_IP_CONNTRACK_NAT_SESSION_RESERVATION /* john.huang 2013.01.25 */
        {
//                .ctl_name       = NET_IPV4_NF_CONNTRACK_MAX_0,
                .procname       = "ip_conntrack_max_0",
                .data           = &nf_conntrack_max_0,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = &proc_dointvec,
        },
