...
#define LOPT_DNSREPLY_STSCONFCLI   289
#endif
...
#if HAS_DNSMASQ_DNSREPLY_TO_SYSCONF_CLI
	{"enable-dnsreply-to-sysconfcli", 1, 0, LOPT_DNSREPLY_STSCONFCLI},
#endif
    { NULL, 0, 0, 0 }
  };
...
#if HAS_DNSMASQ_DNSREPLY_TO_SYSCONF_CLI
  { LOPT_DNSREPLY_STSCONFCLI, ARG_ONE, "<enable>", gettext_noop("Send DNSReply to sysconf_cli."), NULL},  
#endif
  { 0, 0, NULL, NULL, NULL }
}; 
...
#if HAS_DNSMASQ_DNSREPLY_TO_SYSCONF_CLI
	case LOPT_DNSREPLY_STSCONFCLI:
		enable_dnsreply_to_sysconfcli = 1;
		break;
#endif      
...
#ifdef HAS_USAGE_OPTION  /* cfho2007-1011 */
	    do_usage();
#else
	    printf("Usage is disabled!\n");
#endif
	  exit(0);
	}
      else if (option == 'v')
