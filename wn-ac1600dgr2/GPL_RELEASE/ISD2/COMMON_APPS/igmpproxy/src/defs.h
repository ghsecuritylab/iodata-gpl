...
// 2010/01/18 jerry chen: upstream IGMP interface
int hasUpstreamIgmpInf;
char extraInterface[10];
...
void igmplog( int Serverity, int Errno, const char *FmtSt, ... );
